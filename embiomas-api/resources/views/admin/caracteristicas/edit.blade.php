                    ...
                    <div class="space-y-6 mb-6">
                        ...
                        <div>
                            ...
                            <textarea name="descricao_cse" id="descricao_cse" rows="4"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5">{{ old('descricao_cse', $caracteristica_se->descricao_cse) }}</textarea>
                            @error('descricao_cse')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        @if ($caracteristica_se->imagem_cse)
                            <div class="pt-4">
                                ...
                                <img src="{{ asset('storage/' . $caracteristica_se->imagem_cse) }}"
                                    alt="Imagem de {{ $caracteristica_se->nome_cse }}"
                                    class="mt-2 h-40 w-auto rounded-lg shadow-sm">
                            </div>
                        @endif
                        <div>
                            <label for="imagem_cse" class="block text-sm font-medium text-gray-900">Substituir Imagem
                                (Opcional)</label>

<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            Adicionar Novo Elemento de Hidrografia
        </h2>
    </x-slot>
            ...
            <div class="bg-gray-100 p-6 rounded-2xl shadow-sm border border-gray-200">
                <form action="{{ route('hidrografia.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="space-y-6 mb-6">
                        <div>
                            <label for="nome_hidrografia" class="block mb-2 text-sm font-medium text-gray-900">Nome (Ex: Rio, Lagoa, Bacia)</label>
                        ...
                        <div>
                            <label for="tipo_hidrografia" class="block mb-2 text-sm font-medium text-gray-900">Tipo (Opcional)</label>
                            <input type="text" name="tipo_hidrografia" id="tipo_hidrografia"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5"
                                value="{{ old('tipo_hidrografia') }}" placeholder="Ex: Rio, Bacia Hidrográfica, Aquífero">
                        ...
                        <div>
                            ...
                            <textarea name="descricao_hidrografia" id="descricao_hidrografia" rows="4"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5">{{ old('descricao_hidrografia') }}</textarea>
                        ...
                        <div>
                            <label for="imagem_hidrografia" class="block text-sm font-medium text-gray-900">Imagem (Opcional)</label>

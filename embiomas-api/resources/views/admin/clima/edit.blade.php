                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        ...
                        <div>
                            ...
                            <textarea name="descricao_clima" id="descricao_clima" rows="4"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5">{{ old('descricao_clima', $clima->descricao_clima) }}</textarea>
                        ...
                        @if ($clima->imagem_clima)
                            <div>
                                ...
                                <img src="{{ asset('storage/' . $clima->imagem_clima) }}"
                                    alt="Imagem de {{ $clima->nome_clima }}"
                                    class="mt-2 h-40 w-auto rounded-lg shadow-sm">
                            </div>
                        @endif

                        <div>
                            <label for="imagem_clima" class="block text-sm font-medium text-gray-900">Substituir Imagem
                                (Opcional)</label>

        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-gray-100 p-6 rounded-2xl shadow-sm border border-gray-200">
                ...
                <div class="flex flex-col md:flex-row md:justify-between md:items-center mb-6">
                    <h3 class="text-lg font-semibold text-gray-900 mb-4 md:mb-0">Crie ou altere as áreas de preservação</h3>
                        ...
                        <tbody class="bg-gray-100 divide-y divide-gray-200">
                            @forelse ($areas as $item)
                                <tr>
                                    ...
                                    <td class_models="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                                        <div class="flex items-center justify-end space-x-3">
                                            <a href="{{route('areas-preservacao.editMap', ['area_preservacao' => $item])}}" class="text-sm font-medium text-gray-600 hover:text-green-700">
                                                Localização
                                            </a>
